  ...
  return (
    <form
      action={async (data: FormData) =>
        createCommunity(data).then((res: any) => {
          if (res.error) {
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 md:p-10">
        <h2 className="font-cal text-2xl dark:text-white">Create a new Community</h2>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <textarea
            name="description"
            placeholder="Description about why my Community is so awesome"
...
function CreateCommunityFormButton() {
  ...
  return (
    <button
      ...
      disabled={pending}
    >
      {pending ? <LoadingDots color="#808080" /> : <p>Create Community</p>}
    </button>
  );
}
